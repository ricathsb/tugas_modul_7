...
import com.sigmaboy.modul7.databinding.ActivityAddHomeworkBinding
    ...
    fun addNewHomework() {
        ...
        if (isEdit) {
            ...
            if (result > 0) {
                ...
                Toast.makeText(this@AddHomework, "Gagal mengupdate data", Toast.LENGTH_SHORT).show()
            }
        } else {
            ...
            if (result > 0) {
                ...
                Toast.makeText(this@AddHomework, "Gagal menambah data", Toast.LENGTH_SHORT).show()
            }
        }
    }
